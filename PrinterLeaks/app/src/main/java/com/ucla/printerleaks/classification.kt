...
import com.ucla.printerleaks.WavFile
import com.ucla.printerleaks.WavFileException
...
class classification {
    ...
    fun classifyNoise(audioFile: File): String? {
    ...
    public fun loadModelAndMakePredictions(meanMFCCValues: FloatArray): String? {
    ...
    public fun getTopKProbability(labelProb: Map<String, Float>): List<Recognition>? {
